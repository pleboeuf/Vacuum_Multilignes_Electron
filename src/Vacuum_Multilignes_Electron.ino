...
// Date de changement d'heure au Québec: 2ième dimanche de mars (12 mars 2023) +1h.
// Premier dimanche de novembre (5 novembre 2023) -1h.
...
void goToSleep(int sleepType)
{
    ...
    Log.info("(goToSleep) Temp_Summary: Time, Li, Vin, Vbat, SOC, ExtTemp, BatTemp, SI7051 :\t" + timeNow +
                 "\t%.0f\t%.3f\t%.3f\t%.2f\t%.1f\t%.1f\t%.1f",
             lightIntensityLux, readVin(), Vbat, soc, ExtTemp, BatteryTemp, readSI7051());
